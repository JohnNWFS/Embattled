...
function scr_spawn_prize() {
	...
	{
	    case 1:
	    test = instance_create(x,y,obj_armor_bonus);
	    test.increase_armor = 20;
	    break;
   
	    case 2:
	    test = instance_create(x,y,obj_power_bonus);
	    test.increase_shot_power = 1;
	    break;

	    case 3:
	    test = instance_create(x,y,obj_shot_speed_bonus);
